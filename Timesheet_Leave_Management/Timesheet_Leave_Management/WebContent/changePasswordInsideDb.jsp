...
<%
	...
	if(username!="" && newPassword!="" && confirmPassword!="")
	{
		...
		if(newPassword.equals(confirmPassword))
		{
			...
			%>
			<script>
			window.alert("Password must be atleast 6 characters");window.location.href="changePasswordInside.jsp";
			</script>
			<%
			}
		...
		%>
		<script>
		window.alert("New and Confirm Passwords doesnot match");window.location.href="changePasswordInside.jsp";
		</script>
		<%
		}
	}
	...
	{
	%>
	<script>window.alert("New or Confirm Password is empty ");window.location.href="ChangePasswordInside.jsp";
